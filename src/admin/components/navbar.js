    ...
    print() {
        return /*html*/ `
            <div class="hidden md:block">
                ...
                <a href="/admin/addphone" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Phone</a>
    
                <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">laptop</a>
